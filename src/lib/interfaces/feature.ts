...
export interface Feature { 
    featureName: Feature.FeatureNameEnum;
    overridable?: boolean;
}
export namespace Feature {
    export type FeatureNameEnum = 'AUTO_COMMIT' | 'PRE_AUTHORIZATION' | 'RECEIPT_PRINTER' | 'SIGNATURE_CAPTURE' | 'SIGNATURE_CVM_SUPPORTED';
    export const FeatureNameEnum = {
        AUTOCOMMIT: 'AUTO_COMMIT' as FeatureNameEnum,
        PREAUTHORIZATION: 'PRE_AUTHORIZATION' as FeatureNameEnum,
        RECEIPTPRINTER: 'RECEIPT_PRINTER' as FeatureNameEnum,
        SIGNATURECAPTURE: 'SIGNATURE_CAPTURE' as FeatureNameEnum,
        SIGNATURECVMSUPPORTED: 'SIGNATURE_CVM_SUPPORTED' as FeatureNameEnum
    };
}