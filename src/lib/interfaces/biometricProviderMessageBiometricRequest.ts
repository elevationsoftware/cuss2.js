 ...
 */
export interface BiometricProviderMessageBiometricRequest { 
    environment?: BiometricProviderMessageBiometricRequestEnvironment;
    agreementsList?: BiometricProviderMessageBiometricRequestAgreementsList;
