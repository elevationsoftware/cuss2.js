...
exports.BiometricProviderMessageBiometricResponseFailureReason = void 0;
var BiometricProviderMessageBiometricResponseFailureReason;
(function (BiometricProviderMessageBiometricResponseFailureReason) {
    BiometricProviderMessageBiometricResponseFailureReason.FailureCodeEnum = {
        Failed: 'failed',
        Timeout: 'timeout',
        ...
        PoorCameraImage: 'poorCameraImage',
        PoorDocumentImage: 'poorDocumentImage',
        DatasetNotFound: 'datasetNotFound',
        FaceNotDetected: 'faceNotDetected'
    };
})(BiometricProviderMessageBiometricResponseFailureReason = exports.BiometricProviderMessageBiometricResponseFailureReason || (exports.BiometricProviderMessageBiometricResponseFailureReason = {}));
