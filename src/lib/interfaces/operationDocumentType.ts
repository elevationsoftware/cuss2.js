 ...
 */
export type OperationDocumentType = 'NONE' | 'REQUEST' | 'RESPONSE';

export const OperationDocumentType = {
    NONE: 'NONE' as OperationDocumentType,
    REQUEST: 'REQUEST' as OperationDocumentType,
    RESPONSE: 'RESPONSE' as OperationDocumentType
};