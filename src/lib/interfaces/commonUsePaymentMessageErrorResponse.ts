 ...
 */
export interface CommonUsePaymentMessageErrorResponse { 
    /**
     ...
     */
    errorReason: CommonUsePaymentMessageErrorResponse.ErrorReasonEnum;
    /**
...
export namespace CommonUsePaymentMessageErrorResponse {
    export type ErrorReasonEnum = 'DATA_ERROR' | 'FORMAT_ERROR' | 'ILLOGICAL';
    export const ErrorReasonEnum = {
        DATAERROR: 'DATA_ERROR' as ErrorReasonEnum,
        FORMATERROR: 'FORMAT_ERROR' as ErrorReasonEnum,
        ILLOGICAL: 'ILLOGICAL' as ErrorReasonEnum
    };
}