...
/**
 * A media type that the payment terminal is able to accept. The application can restrict these types via setup() if the overridable attribute is true.
 */
export type MediaType = 'ICC' | 'MAG_STRIPE' | 'NFC' | 'RFID';

export const MediaType = {
    ICC: 'ICC' as MediaType,
    MAGSTRIPE: 'MAG_STRIPE' as MediaType,
    NFC: 'NFC' as MediaType,
    RFID: 'RFID' as MediaType
};