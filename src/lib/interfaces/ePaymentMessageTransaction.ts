 ...
 */
export interface EPaymentMessageTransaction { 
    transactionDocumentType: TransactionDocumentType;
    transactionDocumentReturnType?: TransactionDocumentType;
    transactionType: EPaymentMessageTransaction.TransactionTypeEnum;
    transactionRequest?: EPaymentMessageTransactionTransactionRequest;
    transactionResponse?: EPaymentMessageTransactionTransactionResponse;
    transactionAcknowledge?: EPaymentMessageTransactionTransactionAcknowledge;
}
export namespace EPaymentMessageTransaction {
    export type TransactionTypeEnum = 'CANCEL' | 'PRE_AUTH' | 'POST_AUTH' | 'PURCHASE' | 'REFUND' | 'VOID_PURCHASE' | 'VOID_REFUND';
    export const TransactionTypeEnum = {
        CANCEL: 'CANCEL' as TransactionTypeEnum,
        PREAUTH: 'PRE_AUTH' as TransactionTypeEnum,
        POSTAUTH: 'POST_AUTH' as TransactionTypeEnum,
        PURCHASE: 'PURCHASE' as TransactionTypeEnum,
        REFUND: 'REFUND' as TransactionTypeEnum,
        VOIDPURCHASE: 'VOID_PURCHASE' as TransactionTypeEnum,
        VOIDREFUND: 'VOID_REFUND' as TransactionTypeEnum
    };
}