...
export const BiometricProviderMessageType = {
    NONE: 'NONE' as BiometricProviderMessageType,
    REQUEST: 'REQUEST' as BiometricProviderMessageType,
    REQUESTDATA: 'REQUEST_DATA' as BiometricProviderMessageType,
    RESPONSE: 'RESPONSE' as BiometricProviderMessageType
};