 ...
 */
import { BiometricProviderMessageBiometricRequest } from './biometricProviderMessageBiometricRequest';
import { BiometricProviderMessageBiometricRequestData } from './biometricProviderMessageBiometricRequestData';
import { BiometricProviderMessageBiometricResponse } from './biometricProviderMessageBiometricResponse';
import { BiometricProviderMessageType } from './biometricProviderMessageType';

/**
 * Common use biometric provider component request/response message.
 */
export interface BiometricProviderMessage { 
     ...
     */
    biometricFunctionType: BiometricProviderMessage.BiometricFunctionTypeEnum;
    biometricRequest?: BiometricProviderMessageBiometricRequest;
    biometricRequestData?: BiometricProviderMessageBiometricRequestData;
    biometricResponse?: BiometricProviderMessageBiometricResponse;
}
export namespace BiometricProviderMessage {
    export type BiometricFunctionTypeEnum = 'ASSOCIATE' | 'DISASSOCIATE' | 'ENROLL' | 'GET_ASSOCIATIONS' | 'IDENTIFY' | 'PREVIEW' | 'PURGE' | 'VERIFY';
    export const BiometricFunctionTypeEnum = {
        ASSOCIATE: 'ASSOCIATE' as BiometricFunctionTypeEnum,
        DISASSOCIATE: 'DISASSOCIATE' as BiometricFunctionTypeEnum,
        ENROLL: 'ENROLL' as BiometricFunctionTypeEnum,
        GETASSOCIATIONS: 'GET_ASSOCIATIONS' as BiometricFunctionTypeEnum,
        IDENTIFY: 'IDENTIFY' as BiometricFunctionTypeEnum,
        PREVIEW: 'PREVIEW' as BiometricFunctionTypeEnum,
        PURGE: 'PURGE' as BiometricFunctionTypeEnum,
        VERIFY: 'VERIFY' as BiometricFunctionTypeEnum
    };
}