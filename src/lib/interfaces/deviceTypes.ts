 ...
 */
export type DeviceTypes = 'PRINT' | 'READ' | 'MOTORIZED' | 'DIP' | 'SWIPE' | 'CONTACTLESS' | 'INSERT' | 'DISPENSE' | 'CAPTURE' | 'CONVEYOR' | 'SCALE' | 'CHIP_AND_PIN' |  'CAMERA'  | 'EXTERNAL' | 'BIOMETRICS' | 'ASSISTIVE' | 'ILLUMINATION' | 'DISPLAY';
