...
/**
 * Relations for all events <p>  *SOLICITED:* Event relates to an application request <br>  *UNSOLICITED:* Sent by the platform because of any internal change, not related to any request. 
 */
