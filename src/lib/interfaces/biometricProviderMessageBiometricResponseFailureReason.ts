 ...
 */
export interface BiometricProviderMessageBiometricResponseFailureReason { 
    /**
     * Eror code as received and mapped from the IMPs response.
     */
    failureCode: BiometricProviderMessageBiometricResponseFailureReason.FailureCodeEnum;
    /**
...
export namespace BiometricProviderMessageBiometricResponseFailureReason {
    export type FailureCodeEnum = 'FAILED' | 'TIMEOUT' | 'CAMERA_ERROR' | 'INVALID_CONFIGURATION' | 'MATCH_FAILED' | 'NOT_IDENTIFIED' | 'POOR_CAMERA_IMAGE' | 'POOR_DOCUMENT_IMAGE' | 'DATA_SET_NOT_FOUND' | 'FACE_NOT_DETECTED';
    export const FailureCodeEnum = {
        FAILED: 'FAILED' as FailureCodeEnum,
        TIMEOUT: 'TIMEOUT' as FailureCodeEnum,
        CAMERAERROR: 'CAMERA_ERROR' as FailureCodeEnum,
        INVALIDCONFIGURATION: 'INVALID_CONFIGURATION' as FailureCodeEnum,
        MATCHFAILED: 'MATCH_FAILED' as FailureCodeEnum,
        NOTIDENTIFIED: 'NOT_IDENTIFIED' as FailureCodeEnum,
        POORCAMERAIMAGE: 'POOR_CAMERA_IMAGE' as FailureCodeEnum,
        POORDOCUMENTIMAGE: 'POOR_DOCUMENT_IMAGE' as FailureCodeEnum,
        DATASETNOTFOUND: 'DATA_SET_NOT_FOUND' as FailureCodeEnum,
        FACENOTDETECTED: 'FACE_NOT_DETECTED' as FailureCodeEnum
    };
}