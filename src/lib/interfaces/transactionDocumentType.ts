...
export const TransactionDocumentType = {
    NONE: 'NONE' as TransactionDocumentType,
    REQUEST: 'REQUEST' as TransactionDocumentType,
    RESPONSE: 'RESPONSE' as TransactionDocumentType,
    ACK: 'ACK' as TransactionDocumentType
};