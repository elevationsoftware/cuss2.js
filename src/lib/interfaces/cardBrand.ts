...
/**
 * A freeform string identifying the card brand or scheme that can be accepted for payment. It can be a specific application ID, as defined at https://eftlab.com.au/index.php/site-map/knowledge-base/211-emv-aid-rid-pix, or a top-level scheme name from the set { \"AMEX\", \"CART_BLANCHE\", \"DISCOVER\", \"JCB\", \"MAESTRO\", \"MASTERCARD\", \"SWITCH\", \"VISA\" }.
 */
export type CardBrand = 'AMEX' | 'CART_BLANCHE' | 'DISCOVER' | 'JCB' | 'MAESTRO' | 'MASTERCARD' | 'SWITCH' | 'VISA';

export const CardBrand = {
    AMEX: 'AMEX' as CardBrand,
    CARTBLANCHE: 'CART_BLANCHE' as CardBrand,
