 ...
 */
export interface PassengerIDType { 
    identifier?: string;
    identifierType?: PassengerIDType.IdentifierTypeEnum;
}
export namespace PassengerIDType {
    export type IdentifierTypeEnum = 'CLIENT' | 'PROVIDER';
    export const IdentifierTypeEnum = {
        CLIENT: 'CLIENT' as IdentifierTypeEnum,
        PROVIDER: 'PROVIDER' as IdentifierTypeEnum
    };
}