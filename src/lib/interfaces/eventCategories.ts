...
/**
 * Severity categorization for the various events<p> ALARM:* Requires immediate attention (i.e. manual intervention is required) <br> WARNING:* Abnormal situation occurs, but manual intervention is not needed <br> NORMAL:* Normal processing occurs
 */
