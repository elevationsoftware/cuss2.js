 ...
 */
export interface BiometricProviderMessageBiometricResponse { 
    responseType: BiometricProviderMessageBiometricResponse.ResponseTypeEnum;
    failureReason?: BiometricProviderMessageBiometricResponseFailureReason;
    passengerData?: PassengerDataType;
    gpDataList?: GPDataListType;
}
export namespace BiometricProviderMessageBiometricResponse {
    export type ResponseTypeEnum = 'CANCELLATION' | 'FAILURE' | 'NOTIFICATION' | 'SUCCESS';
    export const ResponseTypeEnum = {
        CANCELLATION: 'CANCELLATION' as ResponseTypeEnum,
        FAILURE: 'FAILURE' as ResponseTypeEnum,
        NOTIFICATION: 'NOTIFICATION' as ResponseTypeEnum,
