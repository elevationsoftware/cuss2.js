...
export interface TransactionStatus { 
    transactionStatusID?: TransactionStatus.TransactionStatusIDEnum;
}
export namespace TransactionStatus {
    export type TransactionStatusIDEnum = 'AMOUNT_APPROVAL' | 'APPLICATION_SELECTION' | 'CARD_INSERTION' | 'CARD_REMOVAL' | 'CASHBACK_ENTRY' | 'PIN_ENTRY' | 'PROCESSING';
    export const TransactionStatusIDEnum = {
        AMOUNTAPPROVAL: 'AMOUNT_APPROVAL' as TransactionStatusIDEnum,
        APPLICATIONSELECTION: 'APPLICATION_SELECTION' as TransactionStatusIDEnum,
        CARDINSERTION: 'CARD_INSERTION' as TransactionStatusIDEnum,
        CARDREMOVAL: 'CARD_REMOVAL' as TransactionStatusIDEnum,
        CASHBACKENTRY: 'CASHBACK_ENTRY' as TransactionStatusIDEnum,
        PINENTRY: 'PIN_ENTRY' as TransactionStatusIDEnum,
        PROCESSING: 'PROCESSING' as TransactionStatusIDEnum
    };
}