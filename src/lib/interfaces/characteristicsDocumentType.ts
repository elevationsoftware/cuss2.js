...
export const CharacteristicsDocumentType = {
    NONE: 'NONE' as CharacteristicsDocumentType,
    REQUEST: 'REQUEST' as CharacteristicsDocumentType,
    RESPONSE: 'RESPONSE' as CharacteristicsDocumentType
};