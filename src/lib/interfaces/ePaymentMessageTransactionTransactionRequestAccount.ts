 ...
 */
export interface EPaymentMessageTransactionTransactionRequestAccount { 
    accountType: EPaymentMessageTransactionTransactionRequestAccount.AccountTypeEnum;
    manual?: EPaymentMessageTransactionTransactionRequestAccountManual;
    swipe?: EPaymentMessageTransactionTransactionRequestAccountSwipe;
}
export namespace EPaymentMessageTransactionTransactionRequestAccount {
    export type AccountTypeEnum = 'MANUAL' | 'SWIPE';
    export const AccountTypeEnum = {
        MANUAL: 'MANUAL' as AccountTypeEnum,
        SWIPE: 'SWIPE' as AccountTypeEnum
    };
}