 ...
 */
import { CommonUsePaymentMessageCharacteristicsCharacteristicsResponseSchemaVersionList } from './commonUsePaymentMessageCharacteristicsCharacteristicsResponseSchemaVersionList';

export interface CommonUseBiometricMessageCharacteristicsCharacteristicsResponse { 
    /**
     * DS type(s) string.
     */
    dsTypes: CommonUseBiometricMessageCharacteristicsCharacteristicsResponse.DsTypesEnum;
    schemaVersionList: CommonUsePaymentMessageCharacteristicsCharacteristicsResponseSchemaVersionList;
}
export namespace CommonUseBiometricMessageCharacteristicsCharacteristicsResponse {
    export type DsTypesEnum = 'DS_TYPES_BIOMETRIC_PROVIDER';
    export const DsTypesEnum = {
        DSTYPESBIOMETRICPROVIDER: 'DS_TYPES_BIOMETRIC_PROVIDER' as DsTypesEnum
    };
}