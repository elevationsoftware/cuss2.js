...
exports.EventCodes = void 0;
exports.EventCodes = {
    ECOK: 'EC_OK',
    EVENTHANDLINGREADY: 'EVENTHANDLING_READY',
    UNAVAILABLERELEASEDPLATFORM: 'UNAVAILABLE_RELEASED_PLATFORM',
    EVENTHANDLINGUNAVAILABLE: 'EVENTHANDLING_UNAVAILABLE',
    UNAVAILABLERELEASEDAPPLICATION: 'UNAVAILABLE_RELEASED_APPLICATION',
    READYRELEASEDAPPLICATION: 'READY_RELEASED_APPLICATION',
    READYRELEASEDPLATFORM: 'READY_RELEASED_PLATFORM',
    RELEASEDREADY: 'RELEASED_READY',
    RELEASEDUNAVAILABLE: 'RELEASED_UNAVAILABLE'
};
