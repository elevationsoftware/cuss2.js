 ...
 */
export interface EPaymentMessage { 
    ePaymentMsgType: EPaymentMessage.EPaymentMsgTypeEnum;
    setup?: EPaymentMessageSetup;
    transaction?: EPaymentMessageTransaction;
    operation?: EPaymentMessageOperation;
}
export namespace EPaymentMessage {
    export type EPaymentMsgTypeEnum = 'OPERATION' | 'SETUP' | 'TRANSACTION';
    export const EPaymentMsgTypeEnum = {
        OPERATION: 'OPERATION' as EPaymentMsgTypeEnum,
        SETUP: 'SETUP' as EPaymentMsgTypeEnum,
        TRANSACTION: 'TRANSACTION' as EPaymentMsgTypeEnum
    };
}