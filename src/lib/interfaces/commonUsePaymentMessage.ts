...
export interface CommonUsePaymentMessage { 
     ...
     */
    documentType: CommonUsePaymentMessage.DocumentTypeEnum;
    characteristics?: CommonUsePaymentMessageCharacteristics;
    ePaymentMessage?: EPaymentMessage;
    errorResponse?: CommonUsePaymentMessageErrorResponse;
}
export namespace CommonUsePaymentMessage {
    export type DocumentTypeEnum = 'CHARACTERISTICS' | 'EPAYMENT_MESSAGE' | 'ERROR_RESPONSE';
    export const DocumentTypeEnum = {
        CHARACTERISTICS: 'CHARACTERISTICS' as DocumentTypeEnum,
        EPAYMENTMESSAGE: 'EPAYMENT_MESSAGE' as DocumentTypeEnum,
