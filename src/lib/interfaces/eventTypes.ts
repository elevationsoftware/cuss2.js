...
/**
 * Categorization of publicity for the various events<p>  *PRIVATE:* Private events are sent as a solicited response only to those applications having requested an action on the platform <br> *PUBLIC:* Public events indicate e.g. a state change of a component that is of interest for all applications <br> *PLATFORM:* Sent internally between CUSS Application Manager, CLA, and the Component Interface 
 */
