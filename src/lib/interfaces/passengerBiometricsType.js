...
exports.PassengerBiometricsType = void 0;
var PassengerBiometricsType;
(function (PassengerBiometricsType) {
    PassengerBiometricsType.BiometricsTypeEnum = {
        Face: 'face',
        Finger: 'finger',
        Iris: 'iris',
        Palm: 'palm'
    };
    PassengerBiometricsType.LightTypeEnum = {
        Ir: 'ir',
        Uv: 'uv',
        Visible: 'visible'
    };
    PassengerBiometricsType.DataSourceEnum = {
        BiometricProvider: 'biometric-provider',
        Camera: 'camera',
        MrtdChip: 'mrtd-chip',
        MrtdVisible: 'mrtd-visible',
        Scanner: 'scanner'
    };
    PassengerBiometricsType.DataFormatEnum = {
        Bmp: 'bmp',
        Jpg: 'jpg',
        Png: 'png'
    };
})(PassengerBiometricsType = exports.PassengerBiometricsType || (exports.PassengerBiometricsType = {}));
