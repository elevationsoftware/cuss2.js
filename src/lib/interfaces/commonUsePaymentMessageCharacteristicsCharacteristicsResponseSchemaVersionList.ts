...
/**
 * Supported common use message schema version list. Each supported version must be explicitly listed.
 */
export interface CommonUsePaymentMessageCharacteristicsCharacteristicsResponseSchemaVersionList { 
    schemaVersions: Array<VersionString>;
}