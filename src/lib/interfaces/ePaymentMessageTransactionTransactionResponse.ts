 ...
 */
import { EPaymentMessageTransactionTransactionResponseApproval } from './ePaymentMessageTransactionTransactionResponseApproval';
import { EPaymentMessageTransactionTransactionResponseNonApproval } from './ePaymentMessageTransactionTransactionResponseNonApproval';
import { TransactionStatus } from './transactionStatus';

/**
 * Financial request response from payment component to common use application.
 */
export interface EPaymentMessageTransactionTransactionResponse { 
    responseType: EPaymentMessageTransactionTransactionResponse.ResponseTypeEnum;
    approval?: EPaymentMessageTransactionTransactionResponseApproval;
    nonApproval?: EPaymentMessageTransactionTransactionResponseNonApproval;
    transactionStatus?: TransactionStatus;
}
export namespace EPaymentMessageTransactionTransactionResponse {
    export type ResponseTypeEnum = 'APPROVAL' | 'CANCELLATION' | 'DECLINE' | 'FAILURE' | 'STATUS';
    export const ResponseTypeEnum = {
        APPROVAL: 'APPROVAL' as ResponseTypeEnum,
        CANCELLATION: 'CANCELLATION' as ResponseTypeEnum,
        DECLINE: 'DECLINE' as ResponseTypeEnum,
        FAILURE: 'FAILURE' as ResponseTypeEnum,
        STATUS: 'STATUS' as ResponseTypeEnum
    };
}