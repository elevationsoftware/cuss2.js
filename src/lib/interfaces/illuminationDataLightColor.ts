...
/**
 * The color of the light in RGB values. A value of 255,255,255 means white, a value of 0,0,0 (black) would switch the light off. Instead of separate values for RGB named colour values may be used. - Light may support only a single colour.
 */
